...
public class AcceptFriendArguments : ActionArguments
{
    ...
    public static implicit operator string(AcceptFriendArguments arguments)
    {
        return arguments.ToString();
    }

    public static implicit operator AcceptFriendArguments(string arguments)
    {
        return JsonConvert.DeserializeObject<AcceptFriendArguments>(arguments)!;
    }
}